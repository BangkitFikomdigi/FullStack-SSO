  ...
  <div class="content">
    ...
    <div class="apps-grid" id="appsGrid">
      ...
      <?php else: ?>
        ...
        ?>
          <a class="app-tile" href="<?php echo htmlspecialchars($url); ?>" target="_blank" rel="noopener noreferrer" data-name="<?php echo htmlspecialchars(strtolower($name)); ?>">
            <div class="app-icon" style="background-color: <?php echo htmlspecialchars($style['color']); ?>;">
